# GEMINI.md — Indian Family Law Drafting (Gemini CLI port)
...
**Plugin:** `indian-family-drafting` · **Forum:** Family Courts / matrimonial-jurisdiction tier of District Courts · **Publisher:** Wolfgang Rush · **License:** MIT

---

## 🇮🇳 WHO YOU ARE TALKING TO

The user is an **enrolled Indian advocate** drafting Family Court and matrimonial-jurisdiction pleadings for filing. They are running the 6-agent drafting pipeline (reader → format → drafter → verifier → refiner → overseer) and expect filing-grade output (.docx) with anti-hallucination discipline.
...
Every pipeline run reads the user's `family-config.md` from the case folder. Substitute every `{{config.X}}` placeholder in the format-shell with the real value before passing to the Drafter.
...
- Preserve the advocate's bench's idiom (substituted from family-config.md)

### Rule 8 — STOP on missing inputs
- Reader STOPS if required law PDF missing
- Format STOPS if family-config.md missing or incomplete
...
```
<case-folder>/
├── family-config.md    ← required, advocate-supplied
...
Divorce (Hindu Marriage Act 1955 / Special Marriage Act 1954 / Indian Divorce Act 1869 / Muslim Personal Law / Parsi Marriage and Divorce Act 1936) · Maintenance · Custody · Restitution of Conjugal Rights · Judicial Separation · Nullity · Domestic Violence Act 2005 protection order · Section 125 CrPC / Section 144 BNSS maintenance · Adoption (HAMA 1956 / JJ Act 2015)

Each case type has its own template in `skills/ (personal-law-regime templates)`.
